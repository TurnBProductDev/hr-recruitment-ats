...
urlpatterns = [
    ...
    path('hr/candidates/<int:candidate_id>/interview-requests/<int:request_pk>/manual-allocate/',
         views.InterviewScheduleView.as_view(), name='interview_request_manual_allocate'),
    ...
    path('hr/interview-requests/<int:pk>/reschedule/', views.InterviewRequestRescheduleView.as_view(), name='interview_request_reschedule'),
